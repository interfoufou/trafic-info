...
export default function Home() {
  ...
  return (
    <div 
      className={`min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white ${isRTL ? 'rtl' : 'ltr'}`}
      dir={isRTL ? 'rtl' : 'ltr'}
    >
      {/* Header */}
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                download
                className="flex items-center gap-1.5 px-3 py-2 bg-purple-600 text-white rounded-lg text-sm font-medium shadow-md hover:bg-purple-700"
              >
      ...
      <main className="flex-1 container mx-auto px-4 py-4 pb-24 md:pb-6">
        ...
        {activeTab === 'citizen' && (
          <div className="space-y-4">
            ...
            <Card className="shadow-xl border-2 border-amber-400 bg-gradient-to-br from-amber-50 to-orange-50">
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center text-white text-4xl shadow-xl">
                    💰
                  </div>
                  <div className="flex-1">
                  ...
                  <Button 
                    asChild
                    className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-lg px-8 py-3 text-lg"
                  >
