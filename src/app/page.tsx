...
const translations = {
  ar: {
    ...
    installDesc: 'ثبّت التطبيق باش تكون شريك فعال في المجال المروري',
    installBtn: 'تثبيت',
    later: 'لاحقاً',
    share: 'مشاركة',
    sections: {
      ...
      citizen: {
        ...
        subtitle: 'السلامة المرورية مسؤولية مشتركة',
  ...
  fr: {
    ...
    installDesc: 'Installez l\'application pour être un partenaire actif dans le domaine routier',
    ...
    sections: {
      ...
      citizen: {
        ...
        subtitle: 'La sécurité routière est une responsabilité partagée',
  ...
  en: {
    ...
    install: 'Install App',
    installDesc: 'Install the app to be an active partner in the traffic sector',
    installBtn: 'Install',
    later: 'Later',
    share: 'Share',
    sections: {
      ...
      citizen: {
        ...
        subtitle: 'Road safety is a shared responsibility',
